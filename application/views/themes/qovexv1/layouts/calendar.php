...
<head>
	...
	<!-- Plugin css -->
	<link href="<?= base_url($theme_assets); ?>/libs/fullcalendar/fullcalendar.min.css" rel="stylesheet" type="text/css" />
...
<body data-layout="detached" data-topbar="colored">
	...
	<!-- plugin js -->
	<script src="<?= base_url($theme_assets); ?>/libs/moment/min/moment.min.js"></script>
	<script src="<?= base_url($theme_assets); ?>/libs/jquery-ui/jquery-ui.min.js"></script>
	<script src="<?= base_url($theme_assets); ?>/libs/fullcalendar/fullcalendar.min.js"></script>

	<!-- Calendar init -->
	<script src="<?= base_url($theme_assets); ?>/js/pages/calendar.init.js"></script>
