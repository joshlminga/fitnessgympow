    ...
    (e.prototype.init = function () {
        if (i.isFunction(i.fn.fullCalendar)) {
            ...
            i("#calendar").fullCalendar({
                ...
                events: [
                    { title: "Leg Day", start: new Date(n, a, 1) },
                    { title: "Chest Workout", start: new Date(n, a, t - 5), end: new Date(n, a, t - 2) },
                    { id: 999, title: "Cardio & Bike", start: new Date(n, a, t - 3, 16, 0), allDay: !1 },
                    { id: 999, title: "Lowerback & Upperback", start: new Date(n, a, t + 4, 16, 0), allDay: !1 },
                    { title: "Hand & Hand Muscle", start: new Date(n, a, t, 10, 30), allDay: !1 },
                    { title: "Weights Lifting", start: new Date(n, a, t, 12, 0), end: new Date(n, a, t, 14, 0), allDay: !1 },
                    { title: "Shoulder & Back", start: new Date(n, a, t + 1, 19, 0), end: new Date(n, a, t + 1, 22, 30), allDay: !1 },
                    { title: "Tumbo", start: new Date(n, a, 28), end: new Date(n, a, 29), url: "#" },
                ],
            }),
                i("#add_event_form").on("submit", function (e) {
                    ...
                    if (3 <= a.length) {
                        ...
                        i("#" + n).data("eventObject", r), i("#" + n).draggable({ revert: !0, revertDuration: 0, zIndex: 999 }), t.val("").focus();
                    } else t.focus();
                });
